...
from algorithms import DistanceVectorRouting, LinkStateRouting
...
def main():
    ...
    parser.add_argument("-a", "--algorithm", choices=['distance-vector', 'link-state'], required=True, help="Routing algorithm")
